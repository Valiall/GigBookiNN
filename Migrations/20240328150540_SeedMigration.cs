        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirmName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    FirmLocation = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventPerformer", x => new { x.PerformerId, x.EventOrganiserId });
                    table.ForeignKey(
